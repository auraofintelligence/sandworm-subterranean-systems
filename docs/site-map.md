...
- [Why Dig?](../start.html) - What reasons might make careful digging worth exploring: fewer road strikes, less road damage, parking relief, 24/7 access, erosion care, future spoil as resource, reef habitat, power storage and community assets?
...
## Builders
- [Entry Trail Builder](../builders/entry-trail.html) - Choose a doorway into Sandworm without needing to accept the whole vision.
- [Ferry Maker-Space Brief Builder](../builders/maker-space-brief.html) - Turn the Dunwich / Gumpi start into a small buildable workshop or open-data brief.
- [Digital Twin Brief Builder](../builders/digital-twin-brief.html) - Map a place or system while keeping people, culture and data sovereign.
- [Sandworm Experiment Builder](../builders/sandworm-experiment.html) - Turn a subterranean systems idea into a cautious prototype question.
- [Spoil Loop Brief Builder](../builders/spoil-loop-brief.html) - Track how sand spoil could become blocks, reef modules, dune support, tunnel lining or stored heat.
- [Reef, Bank And Quiet Power Builder](../builders/reef-energy-brief.html) - Draft a reef or power idea that starts with ecology, surf, safety and reversibility.
- [Wealth And C-Hour Stewardship Builder](../builders/wealth-stewardship-brief.html) - Connect a Sandworm asset idea to transparent stewardship, receipts and local benefit.
- [Film And Documentary Trail Builder](../builders/film-documentary-trail.html) - Carry a Sandworm idea into fiction, documentary or festival planning without taking over the story.
- [Source Trail Builder](../builders/source-trail.html) - Separate concept fuel, public evidence, open questions and claims that need checking.
- [Boundary Check Builder](../builders/boundary-check.html) - Name consent, privacy, cultural, ecological, legal and safety limits before a trail grows.

## Source Bridges
- [Dunwich / Gumpi Ferry Terminal Open Data Lab](https://auraofintelligence.github.io/dunwich-gumpi-ferry-terminal-open-data-lab/) - [Dunwich / Gumpi Ferry Terminal Open Data Lab repo](https://github.com/auraofintelligence/dunwich-gumpi-ferry-terminal-open-data-lab)
...
- [Film Club Documentary Builders](https://auraofintelligence.github.io/film-club-documentary-builders/) - [Film Club Documentary Builders repo](https://github.com/auraofintelligence/film-club-documentary-builders)
